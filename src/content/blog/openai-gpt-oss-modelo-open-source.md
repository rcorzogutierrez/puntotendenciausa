...
La respuesta honesta tiene que ver con la competencia. DeepSeek, el laboratorio chino de IA, demostró que es posible construir modelos de clase mundial con una fracción del presupuesto de OpenAI y publicarlos abiertamente. [Meta](/blog/meta-avocado-ia-retraso-google-gemini/) lleva años publicando su familia LLaMA. Mistral, empresa francesa, se ha posicionado como la alternativa open source más seria de Europa.
...
Con gpt-oss, OpenAI entra de lleno al juego open source sin renunciar a sus productos comerciales. [GPT-5](/blog/openai-25-mil-millones-ingresos-ipo-bolsa/) y sus modelos premium siguen existiendo para quienes quieran las capacidades máximas. gpt-oss es para el ecosistema de desarrolladores que construyen cosas propias.

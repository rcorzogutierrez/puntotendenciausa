---
title: "Vercel sufre segundo robo de datos: qué pasó"
description: "Vercel descubre un segundo compromiso de cuentas tras ampliar su investigación del hackeo de abril. Datos de clientes fueron robados antes del ataque inicial."
pubDate: "2026-04-24"
...
Este incidente se suma a una tendencia preocupante: [hackers explotan fallas en Windows sin parches](https://latendenciausa.web.app/blog/hackers-explotan-fallas-windows-sin-parches/) y las empresas tardan en detectar brechas. En el caso de Vercel, tardaron semanas en descubrir que había un segundo ataque. ¿Cuántos otros incidentes podría haber sin detectar?
...
Esto es especialmente delicado considerando que [el FBI compra datos de ubicación para rastrear a ciudadanos sin orden judicial](https://latendenciausa.web.app/blog/fbi-compra-datos-ubicacion-rastrear-ciudadanos/). Si la seguridad de plataformas críticas como Vercel se ve comprometida, la privacidad de todos estamos en riesgo.

...
Apple anunció una colaboración que pocos anticipaban: integrar el modelo [**Gemini de Google**](/blog/google-gemini-flash-lite-modelo-barato/) directamente en Siri. No como reemplazo, sino como una capa de inteligencia más profunda que le permite al asistente hacer algo que antes simplemente no podía: *entender lo que está pasando en tu pantalla*.
